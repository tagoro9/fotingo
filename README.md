...
fotingo/3.5.1 linux-x64 node-v14.19.0
...
_See code: [src/commands/release.ts](https://github.com/tagoro9/fotingo/blob/v3.5.1/src/commands/release.ts)_
...
_See code: [src/commands/review.ts](https://github.com/tagoro9/fotingo/blob/v3.5.1/src/commands/review.ts)_
...
_See code: [src/commands/start.ts](https://github.com/tagoro9/fotingo/blob/v3.5.1/src/commands/start.ts)_
...
_See code: [src/commands/verify.ts](https://github.com/tagoro9/fotingo/blob/v3.5.1/src/commands/verify.ts)_
<!-- commandsstop -->
<!-- prettier-ignore-end -->
