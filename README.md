...
fotingo/3.4.2 linux-x64 node-v12.22.1
...
_See code: [src/commands/release.ts](https://github.com/tagoro9/fotingo/blob/v3.4.2/src/commands/release.ts)_
...
_See code: [src/commands/review.ts](https://github.com/tagoro9/fotingo/blob/v3.4.2/src/commands/review.ts)_
...
_See code: [src/commands/start.ts](https://github.com/tagoro9/fotingo/blob/v3.4.2/src/commands/start.ts)_
...
_See code: [src/commands/verify.ts](https://github.com/tagoro9/fotingo/blob/v3.4.2/src/commands/verify.ts)_
<!-- commandsstop -->
<!-- prettier-ignore-end -->
