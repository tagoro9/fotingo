...
var createPullRequest = _ramda2['default'].composeP(_ramda2['default'].compose(_util2.wrapInPromise, _ramda2['default'].prop('data')), (0, _util2.promisify)(github.pullRequests.create));
var addLabels = _ramda2['default'].composeP(_ramda2['default'].compose(_util2.wrapInPromise, _ramda2['default'].prop('data')), (0, _util2.promisify)(github.issues.addLabels));
var getLabels = _ramda2['default'].composeP(_ramda2['default'].compose(_util2.wrapInPromise, _ramda2['default'].prop('data')), (0, _util2.promisify)(github.issues.getLabels));
...
var authenticateAndGetCurrentUser = _ramda2['default'].composeP(_ramda2['default'].compose((0, _error.catchPromiseAndThrow)('github', function (e) {
  (0, _util2.debug)('github', 'Error when authenticating: ' + e.message);
  switch (e.code) {
    case '500':
...
var buildPullRequestFooter = function () {
  function buildPullRequestFooter(issueRoot, addLinksToIssues) {
    return _ramda2['default'].compose(_ramda2['default'].ifElse(_ramda2['default'].isEmpty, _ramda2['default'].always(''), _ramda2['default'].compose(_ramda2['default'].concat(_ramda2['default'].__, '.'), _ramda2['default'].concat('\nFixes '), _ramda2['default'].join(', '))), _ramda2['default'].map(function (_ref) {
      var raw = _ref.raw,
          issue = _ref.issue;
      return addLinksToIssues ? '[' + raw + '](' + issueRoot + issue + ')' : '' + raw;
...
var buildPullRequestDescription = function () {
  function buildPullRequestDescription(issueRoot, addLinksToIssues) {
    return _ramda2['default'].converge(_ramda2['default'].compose(_util2.wrapInPromise, _ramda2['default'].unapply(_ramda2['default'].join('\n'))), [buildPullRequestTitle, _ramda2['default'].compose(buildPullRequestBody, _ramda2['default'].prop('commits'), _ramda2['default'].nthArg(1)), _ramda2['default'].compose(buildPullRequestFooter(issueRoot, addLinksToIssues), _ramda2['default'].prop('issues'), _ramda2['default'].nthArg(1))]);
  }
...
var addLabelsToPullRequest = _ramda2['default'].curryN(4, function (config, project, branchInfo, pullRequest) {
  return _ramda2['default'].composeP(_ramda2['default'].compose(_util2.wrapInPromise, _ramda2['default'].always(pullRequest)), addLabels)({
    owner: config.get(['github', 'owner']),
    repo: project,
...
exports['default'] = {
  ...
  createPullRequest: _ramda2['default'].curryN(6, function (config, project, issue, issueRoot, _ref2, branchInfo) {
    var addLinksToIssues = _ref2.addLinksToIssues;
    ...
    _ramda2['default'].composeP(_ramda2['default'].compose(_util2.wrapInPromise, _ramda2['default'].set(_ramda2['default'].lensProp('pullRequest'), _ramda2['default'].__, { branchInfo: branchInfo })), addLabelsToPullRequest(config, project, branchInfo), _ramda2['default'].compose((0, _error.catchPromiseAndThrow)('github', function (e) {
      switch (e.code) {
        case 500:
          return _error.errors.github.cantConnect;
        default:
          return _error.errors.github.pullRequestAlreadyExists;
      }
    }, branchInfo), submitPullRequest(config, project, branchInfo)))), (0, _util2.debugCurriedP)('github', 'Submitting pull request to github'), allowUserToEditPullRequest, (0, _util2.debugCurriedP)('github', 'Editing pull request description'), buildPullRequestDescription(issueRoot, addLinksToIssues))(issue, branchInfo, addLinksToIssues);
  }),
  checkAndGetLabels: _ramda2['default'].curryN(4, function (config, project, labels, branchInfo) {
    return _ramda2['default'].composeP(_ramda2['default'].compose(_ramda2['default'].set(_ramda2['default'].lensProp('labels'), _ramda2['default'].__, branchInfo), _ramda2['default'].map(_ramda2['default'].prop('name')), _ramda2['default'].filter(_ramda2['default'].compose(_ramda2['default'].contains(_ramda2['default'].__, labels), _ramda2['default'].prop('name')))), _ramda2['default'].unless(_ramda2['default'].compose(function (names) {
      return _ramda2['default'].all(_ramda2['default'].contains(_ramda2['default'].__, names), labels);
    }, _ramda2['default'].map(_ramda2['default'].prop('name'))), (0, _error.throwControlledError)(_error.errors.github.invalidLabel)), getLabels)({ owner: config.get(['github', 'owner']), repo: project });
  })
};