...
exports['default'] = {
  ...
  createPullRequest: _ramda2['default'].curryN(5, function (config, project, issue, issueRoot, branchInfo) {
    ...
    _ramda2['default'].composeP(_ramda2['default'].compose(_util2.wrapInPromise, _ramda2['default'].set(_ramda2['default'].lensProp('pullRequest'), _ramda2['default'].__, { branchInfo: branchInfo })), addLabelsToPullRequest(config, project, branchInfo), submitPullRequest(config, project, branchInfo))), (0, _util2.debugCurriedP)('github', 'Submitting pull request to github'), allowUserToEditPullRequest, (0, _util2.debugCurriedP)('github', 'Editing pull request description'), buildPullRequestDescription(issueRoot))(issue, branchInfo);
  }),
