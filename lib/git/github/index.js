...
// Array -> String
var buildPullRequestBody = _ramda2['default'].compose(_ramda2['default'].join('\n'), _ramda2['default'].map(_ramda2['default'].converge(_ramda2['default'].concat, [_ramda2['default'].compose(_ramda2['default'].concat('* '), _ramda2['default'].prop('header')), _ramda2['default'].compose(_ramda2['default'].replace(/\n|^/g, '\n  '), _ramda2['default'].prop('body'))])));
// Array -> String
