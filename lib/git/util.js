...
var getIssueIdFromBranch = exports.getIssueIdFromBranch = _ramda2['default'].compose(_ramda2['default'].toUpper, _ramda2['default'].last, _ramda2['default'].match(/\w\/(\w+-\d+)/));