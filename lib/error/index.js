...
var catchPromiseAndThrow = exports.catchPromiseAndThrow = function () {
  function catchPromiseAndThrow(module, e, parameters) {
    return function (p) {
      return p['catch'](function (err) {
        if (_ramda2['default'].is(Function, e)) {
          (0, _util.debug)(module, err);
          throwControlledError(e(err), parameters)(err);
        } else {
          _ramda2['default'].compose(throwControlledError(e, parameters), (0, _util.debugCurried)(module, err))(err);
        }
      });
    };
  }
