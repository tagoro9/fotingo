...
var error = exports.error = _ramda2['default'].ifElse(_ramda2['default'].is(Error), _ramda2['default'].compose(_ramda2['default'].forEach(_reporter2['default'].error), _ramda2['default'].props(['stack'])), _ramda2['default'].compose(_reporter2['default'].error, _ramda2['default'].ifElse(_ramda2['default'].is(String), _ramda2['default'].identity, _ramda2['default'].partialRight(JSON.stringify, [null, 2]))));
