...
func NewDefaultConfig() *viper.Viper {
	...
	config.SetDefault("tracker.labels.inProgress", "")
	config.SetDefault("tracker.labels.inReview", "")
	config.SetDefault("tracker.comments.pullRequestCreated", "Pull request created: {{.PullRequest.URL}}")
