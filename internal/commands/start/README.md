...
## func [IssueMatchesAllowedTypes](<https://github.com/tagoro9/fotin-go/blob/main/internal/commands/start/helpers.go#L45>)
...
## func [ParseInteractiveLabels](<https://github.com/tagoro9/fotin-go/blob/main/internal/commands/start/helpers.go#L28>)
...
## func [ParseIssueKind](<https://github.com/tagoro9/fotin-go/blob/main/internal/commands/start/helpers.go#L10>)
...
## func [ProjectIssueTypeNames](<https://github.com/tagoro9/fotin-go/blob/main/internal/commands/start/helpers.go#L58>)
...
## func [ResolveIssueLink](<https://github.com/tagoro9/fotin-go/blob/main/internal/commands/start/link_resolver.go#L40>)
...
## func [SelectIssueLinkWithPicker](<https://github.com/tagoro9/fotin-go/blob/main/internal/commands/start/picker.go#L48-L52>)
...
## func [SelectIssueWithPicker](<https://github.com/tagoro9/fotin-go/blob/main/internal/commands/start/picker.go#L14-L20>)
...
## type [IssueLinkClient](<https://github.com/tagoro9/fotin-go/blob/main/internal/commands/start/link_resolver.go#L12-L16>)
...
## type [ResolveIssueLinkErrors](<https://github.com/tagoro9/fotin-go/blob/main/internal/commands/start/link_resolver.go#L31-L37>)
...
## type [ResolveIssueLinkOptions](<https://github.com/tagoro9/fotin-go/blob/main/internal/commands/start/link_resolver.go#L19-L28>)
...
## type [RunPickerFunc](<https://github.com/tagoro9/fotin-go/blob/main/internal/commands/start/picker.go#L11>)
...
## type [WorkflowDeps](<https://github.com/tagoro9/fotin-go/blob/main/internal/commands/start/workflow.go#L41-L50>)
...
## type [WorkflowEmitter](<https://github.com/tagoro9/fotin-go/blob/main/internal/commands/start/workflow.go#L33-L38>)
...
## type [WorkflowOptions](<https://github.com/tagoro9/fotin-go/blob/main/internal/commands/start/workflow.go#L19-L22>)
...
## type [WorkflowResult](<https://github.com/tagoro9/fotin-go/blob/main/internal/commands/start/workflow.go#L25-L30>)
...
## type [WorkflowRunner](<https://github.com/tagoro9/fotin-go/blob/main/internal/commands/start/workflow.go#L53-L58>)
...
### func \(WorkflowRunner\) [RunInteractive](<https://github.com/tagoro9/fotin-go/blob/main/internal/commands/start/workflow.go#L69>)
...
### func \(WorkflowRunner\) [RunWithResult](<https://github.com/tagoro9/fotin-go/blob/main/internal/commands/start/workflow.go#L94>)
