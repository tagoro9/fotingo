...
var configKeySpecs = []configKeySpec{
	...
	{Key: "git.worktree.path", ValueType: configValueTypeString, Description: "Parent directory for start worktrees"},
	...
	{Key: "tracker.labels.inProgress", ValueType: configValueTypeString, Description: "Comma-separated issue-tracker labels applied when work starts"},
	{Key: "tracker.labels.inReview", ValueType: configValueTypeString, Description: "Comma-separated issue-tracker labels applied when a pull request is created"},
	{Key: "tracker.comments.pullRequestCreated", ValueType: configValueTypeString, Description: "Issue-tracker comment template for created pull requests; empty disables comments"},
